...
GO
ALTER TABLE [dbo].[Client] ALTER COLUMN [ClientBalance] FLOAT (53) NOT NULL;


GO
PRINT N'Refreshing Procedure [dbo].[Client_Get]...';
...
GO
PRINT N'Refreshing Procedure [dbo].[Client_GetAll]...';
...
GO
PRINT N'Refreshing Procedure [dbo].[Client_Insert]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[Client_Insert]';
